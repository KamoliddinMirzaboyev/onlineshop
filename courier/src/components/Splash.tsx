...
/**
 * Boot splash. Shown once while the app verifies the session / warms the cache.
 * Parent unmounts it (inside <AnimatePresence>) when ready; the exit animation
 * fades + scales the whole overlay away.
 */
