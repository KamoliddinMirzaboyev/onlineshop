...
const dict = {
  uz: {
    ...
    address_confirm: "Manzil to'g'riligiga ishonch hosil qiling",
    address_auto: "Avtomatik aniqlangan manzil",
  ...
  ru: {
    ...
    address_confirm: "Убедитесь, что адрес указан верно",
    address_auto: "Автоматически определённый адрес",
